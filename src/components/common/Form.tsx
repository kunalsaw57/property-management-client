import { Box, Typography, FormControl, FormHelperText, TextField, TextareaAutosize, Stack, Select, MenuItem, Button, fontWeight, fontSize } from '@pankod/refine-mui'
        ...
        <Box>
            ...
            <Box mt={2.5} borderRadius="15px" padding="20px" bgcolor="#fcfcfc" >
                <form style={{ marginTop: '20px', width: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }} onSubmit={handleSubmit(onFinishHandler)}>
                    ...
                    <FormControl>
                        <FormHelperText sx={{ fontWeight: 500, margin: '10px', fontSize: 16, color: "#11142d" }}>Enter property discription</FormHelperText>
                        <TextareaAutosize
                            minRows={5}
                            required
                            ...
                            color="info"
                            style={{
                                width: '100%', background: 'transparent', fontSize: '16px', borderColor: '(0,0,0,0.23)',
