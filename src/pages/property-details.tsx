                ...
                <Box width="100%" flex={1} maxWidth={326} display="flex" flexDirection="column" gap="20px">
                    ...
                    >
                        ...
                        <Stack mt={2} justifyContent="center" alignItems="center" textAlign="center">
                            <img alt="alt text" src={propertyDetails.creator.avatar} width={90} height={90} style={{ borderRadius: '100%', objectFit: 'cover' }} />
                            ...
                            <Stack mt="15px" direction="row" alignItems="center" gap={1}>
                                <Place sx={{ color: '#808191' }} />
                                <Typography fontSize={14} fontWeight={400} color="#808191">Kanpur, Uttar Pradesh</Typography>
                            </Stack>
                    ...
                    <Stack>
                        <img alt="alt text" src="https://serpmedia.org/scigen/images/googlemaps-nyc-standard.png?crc=3787557525" width="100%" height={306} style={{ borderRadius: 10, objectFit: 'cover' }} />
                    </Stack>
